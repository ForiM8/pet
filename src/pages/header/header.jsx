    ...
    return (
        <div className="header__container">
            <div className="container__block">
                <Link to='/' className="container__block__logo">
                ...
                <div className="container__block__text">
                    <Link className="container__block__text active">Home</Link>
                    <Link className="container__block__text">Shop</Link>
                ...
                <div className="container__block__icon">
                    ...
                    <div className="container__block__icon__icon">
                    ...
                    <Link to={'./basket'} className="container__block__icon__block">
                        <div className="container__block__icon__block-icon">
                        ...
                        <div className="container__block__icon__block-count">{buyCount}</div>
                    </Link>
                    {!isAuth && (<button className="container__block__icon__login" onClick={() => setModalActive(prev => !prev)}>
                            <div className="container__block__icon__login-png"></div>
                            <div className="container__block__icon__login-text">Login</div>
                    </button>)}
                    {isAuth && (<button  className="container__block__icon__login">

                            <Link to="/profile" className="container__block__icon__login-text" style={{textDecoration:'none'}}>{dataProfile?.user}admin</Link>
                    </button>)}
