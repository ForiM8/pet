        ...
        <div className="header__container">
            <div className="container__block">
                ...
                <div className="container__block__icon">
                    ...
                    <div className="container__block__icon__block">
                    ...
                    {isAuth && (<button  className="container__block__icon__login">
                            ...
                            <Link to="/profile" className="container__block__icon__login-text" style={{textDecoration:'none'}}>{dataProfile?.user};lkjhgfds</Link>
                    </button>)}
