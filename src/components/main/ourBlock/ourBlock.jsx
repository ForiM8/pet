export const OurBlock = ({
    ...
    return (
        <div className="main__container__ourBlock__main__block">
            <div className={className}></div>
            <div className="main__container__ourBlock__main__block__textBlock">
                <div className="main__container__ourBlock__main__block__textBlock-textGreen">{greenText}</div>
                <div className="main__container__ourBlock__main__block__textBlock-bigText">{bigText}</div>
                <div className="main__container__ourBlock__main__block__textBlock-smallText">{smallText}</div>
                <div className="main__container__ourBlock__main__block__textBlock-more">Read More <svg style={{ marginLeft: "3px" }} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
